 ...
 * choice before React mounts so visitors never see a theme flash.
 */
export const THEME_STORAGE_KEY = 'rakuen-theme';

/** The visitor's explicit choice, or null while they are using the default. */
export function storedTheme(): Theme | null {
  // Storage throws rather than returning null when it is blocked (Safari
  // private browsing, embedded webviews). Falling back to dark is safe there —
